...
for the Mastercard decoder site.
...
This is a separate key pool from the Visa site's keys.json - a Visa key
will NOT unlock the Mastercard site and vice versa, since each site has
its own keys.json on its own Render service.
"""
...
def make_key():
    # Format: MC-XXXX-XXXX-XXXX (easy to read out loud / paste)
